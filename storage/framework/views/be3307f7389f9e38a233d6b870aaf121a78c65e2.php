...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #eeeeee; direction: ltr;">
<!--[if IE]>
            ...
            <div style="background-color:transparent;">
                <div class="block-grid mixed-two-up"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding-right: 15px; padding-left: 15px; padding-top:15px; padding-bottom:15px;background-color:#c39540;">
                        <![endif]-->
                        <div class="col num12"
                             style="display: table-cell; vertical-align: top; max-width: 320px; min-width: 450px; background-color: #c39540; width: 450px;">
                                    ...
                                    <div style="color:#ffffff;font-family: 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Geneva, Verdana, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="text-align: center">
                                            <img align="center" alt="Alternate text" border="0"
                                                 ...
                                                 src="https://lilacmarketingevents.com/tarrab-api/public/images/logo-white.png"
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr style="vertical-align: top;" valign="top">
                                                        <td height="40"
                                                            ...
                                                            valign="top"><span>
															   <p style="color:#555555; line-height: 1.8; word-break: break-word;  font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 48px;padding: 0 30px; margin: 0; font-size: 14px; text-align: <?php echo e(trans('notification.align')); ?>">
                                                <span style=""><strong>
													                <?php echo e(trans('notification.Regards')); ?><br>
																  <?php echo e(trans('all.site-title')); ?>
                                    ...
                                    <div align="center" class="button-container"
                                        ...
                                        <![endif]--><a href="<?php echo e(config('app.website_url')); ?>}}"
                                                       ...
                                                       target="_blank"><span
                                                style="padding-left:45px;padding-right:45px;font-size:16px;display:inline-block;"><span
                                                    style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><?php echo e(trans("notification.Visit our website")); ?></span></span></a>
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr align="center"
                                                        ...
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;"
                                                            valign="top">
                                                            <a href="<?php echo e(config('app.website_url') . 'privacy-policy'); ?>" target="_blank">
                                                                Privecy Policy
                                                            </a>
                                                        </td>
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;"
                                                            valign="top">
                                                            <a href="<?php echo e(config('app.website_url') . 'terms-and-conditions'); ?>" target="_blank">
                                                                Term and Conditions
                                                            </a>
                                                        </td>
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;"
                                    ...
                                    <div style="color:#555555;font-family:'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:5px;padding-right:25px;padding-bottom:5px;padding-left:25px;">
                                        <div style="line-height: 1.2; font-size: 12px; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 17px; margin: 0;">
...
<?php /**PATH C:\wamp64\www\lilac\ecommerce-api\resources\views/emails/main.blade.php ENDPATH**/ ?>