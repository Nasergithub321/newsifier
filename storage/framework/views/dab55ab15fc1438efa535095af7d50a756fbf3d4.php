                                ...
                                <div
                                    ...
                                    <p style="font-size: 30px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 36px; margin: 0;">
                                                <span style="font-size: 30px;"><strong>
													                <?php echo e(trans('notification.Hello!')); ?>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span style="font-size: 15px;">
											 <?php echo e(trans('notification.welcome-newsletter')); ?>

                                        <br>
											 <?php echo e(trans('notification.thank-u-newsletter')); ?>

                                        <br>
											 <?php echo e(trans('notification.newsletter-email-1')); ?>

                                        <br>
											 <?php echo e(trans('notification.newsletter-email-2')); ?>
...
<?php echo $__env->make('emails.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lilac\ecommerce-api\resources\views/emails/user-newsletter-notification.blade.php ENDPATH**/ ?>