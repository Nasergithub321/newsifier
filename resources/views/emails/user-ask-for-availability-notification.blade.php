                                ...
                                <div
                                    ...
                                    <p style="font-size: 30px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 36px; margin: 0;">
                                                <span style="font-size: 30px;"><strong>
													                 {{trans('notification.Hello',  ['user'=>$data->name])}}
                                                    </strong></span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span style="font-size: 15px;">
                                        {{trans('notification.Thanks for getting in touch!')}}
                                        <br>
											 {{       trans('notification.user-ask-for-availability-notification') }}
                                        <br>
											 {{       trans('notification.Our team will contact you as soon as possible') }}
									</span>
                                    </p>
                                </div>
                            </div>
