                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr style="vertical-align: top;" valign="top">
                                                        <td height="40"
                                                            ...
                                                            valign="top"><span>
															   <p style="color:#555555; line-height: 1.8; word-break: break-word;  font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 48px;padding: 0 30px; margin: 0; font-size: 14px; text-align: {{ trans('notification.align')
																	}}">
                                                <span style=""><strong>
                                    ...
                                    <div align="center" class="button-container"
                                        ...
                                        <![endif]--><a href="{{ config('app.website_url') }}}}"
                                                ...
                                                style="padding-left:45px;padding-right:45px;font-size:16px;display:inline-block;"><span
                                                    style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">{{ trans("notification.Visit our website") }}</span></span></a>
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr align="center"
                                                        ...
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;"
                                                            valign="top">
                                                            <a href="{{ config('app.website_url') . 'privacy-policy' }}" target="_blank">
                                                                Privecy Policy
                                                            </a>
                                                        </td>
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;"
                                                            valign="top">
                                                            <a href="{{ config('app.website_url') . 'terms-and-conditions' }}" target="_blank">
                                                                Term and Conditions
                                                            </a>
                                                        </td>
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 10px; padding-left: 10px;"
