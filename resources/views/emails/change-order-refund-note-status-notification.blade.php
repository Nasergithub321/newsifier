                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span style="font-size: 15px;">
											  {{
                trans('notification.change-order-status-notification', [
                    'user' => $user->first_name . ' ' . $user->last_name,
                    'status' => trans('notification.' . \App\Constants\Constants::ORDER_STATUS_NAME[$order->status_id])
                     ])
                }}.
									</span>
                                    </p>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: {{ trans('notification.right-en-text') }}; mso-line-height-alt: 17px; margin: 0;">
                                            <strong><span
                                                    style="font-size: 15px;">{{trans('notification.branch')}}  :</span></strong>
                                        </p>
                                    </div>
                                </div>
                                <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
                                        <p style="font-size: 15px; line-height: 1.2; word-break: break-word; text-align: {{ trans('notification.left-en-text') }}; mso-line-height-alt: 18px; margin: 0;">
                                            <span style="font-size: 15px;">{{ ($order->branch)?$order->branch->translation(App::getLocale())->first()->name:'' }}</span></p>
                                    </div>
                                </div>
                                <!--[if mso]></td></tr></table><![endif]-->
                                <!--[if (!mso)&(!IE)]><!-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: {{ trans('notification.right-en-text')}}; mso-line-height-alt: 17px; margin: 0;">
                                        <strong><span
                                                style="font-size: 15px;">{{trans('notification.Status-refund-note')}}  :</span></strong>
                                    </p>
                                </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p style="font-size: 15px; line-height: 1.2; word-break: break-word; text-align: {{ trans('notification.left-en-text') }}; mso-line-height-alt: 18px; margin: 0;">
                                        <span
                                            style="font-size: 15px;">{{ trans("notification.". \App\Constants\Constants::ORDER_REFUND_NOTE_STATUS_NAME[$order_note->status] )}}</span>
                                    </p>
                                </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
