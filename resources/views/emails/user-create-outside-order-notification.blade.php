                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span style="font-size: 15px;">
											 {{       trans('notification.we-are-glad-to-be-at-your-service') }}
                                        <br>
											 {{       trans('notification.successfully-received') }}
                                        <br>
											 {{       trans('notification.our-sales-team-will-contact') }}
                                        <br>
											 {{       trans('notification.newsletter-email-2') }}
									</span>
                                    </p>
                                </div>
                            </div>
