                            ...
                            <div
                              ...
                              <p style="font-size: 22px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 26px; margin: 0;">
                                    <span style="font-size: 22px;">
										{{         trans('notification.Dear' , ['user' => $user->first_name . ' ' . $user->last_name ]) }} </span>
                                </p>
                            ...
                            <div
                                ...
                                <p style="font-size: 15px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 18px; margin: 0;">
                                    <span style="font-size: 15px;">
											{{
                     trans('notification.delete-user-notification', [
                      'admin' => $admin->first_name . ' ' . $admin->last_name,
                       'user' => $deleted_user->first_name . ' ' . $deleted_user->last_name
                      ])
                 }}.
									</span>
                                </p>
                                    ...
                                    <div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 15px; line-height: 1.2; word-break: break-word; text-align: {{ trans('notification.left-en-text') }}; mso-line-height-alt: 18px; margin: 0;">
                                                <span style="font-size: 15px;">
                                                   {{$deleted_user->first_name  .' ' . $deleted_user->last_name}} </span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if (!mso)&(!IE)]><!-->
                                    ...
                                    <div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
                                            ...
                                            text-align:{{ trans('notification.left-en-text') }}; mso-line-height-alt: 18px; margin: 0;">
                                                <span style="font-size: 15px;">{{ $deleted_user->email }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="color:#555555;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.2;padding-top:5px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: {{ trans('notification.right-en-text')}}; mso-line-height-alt: 17px; margin: 0;">
                                                <strong><span style="font-size: 15px;">{{trans('notification.role')}} :</span></strong>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                        ...
                                        <div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
                                            <p style="font-size: 15px; line-height: 1.2; word-break: break-word; text-align: {{ trans('notification.left-en-text') }}; mso-line-height-alt: 18px; margin: 0;">
												...
												@if($deleted_user->role())
													@foreach($deleted_user->role() as $key => $val)
													{{ $val }} <br />
													@endforeach
													@else
													{{ $deleted_user->role() }}
