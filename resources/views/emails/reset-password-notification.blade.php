                        ...
                        <div
                            ...
                            <div
                              ...
                              <p style="font-size: 22px; line-height: 1.2; word-break: break-word; text-align: center; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; mso-line-height-alt: 26px; margin: 0;">
                                    <span style="font-size: 22px;">               {{ trans('auth.notify-user-reset-password-message') }}
             </span>
                                </p>
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 href="{{ url($url.'/password/reset/'.$token) }}"
                                                                 style="height:31.5pt; width:216.75pt; v-text-anchor:middle;"
                                                                 arcsize="10%" stroke="false" fillcolor="#c39540">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0,0,0,0">
                                                            <center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
                                        <![endif]--><a href="{{ url($url.'/password/reset/'.$token) }}"
                                                       style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #c39540; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: auto; width: auto; border-top: 1px solid #c39540; border-right: 1px solid #c39540; border-bottom: 1px solid #c39540; border-left: 1px solid #c39540; padding-top: 5px; padding-bottom: 5px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;"
                                                       target="_blank"><span
